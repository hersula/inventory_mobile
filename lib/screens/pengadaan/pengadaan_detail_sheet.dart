...
class PengadaanDetailSheet extends StatefulWidget {
  final int id;
  const PengadaanDetailSheet({super.key, required this.id});

  @override
  State<PengadaanDetailSheet> createState() => _PengadaanDetailSheetState();
}

class _PengadaanDetailSheetState extends State<PengadaanDetailSheet> {
                  ...
                  : _data == null
                      ...
                      : ListView(
                          ...
                          children: [
                            Row(children: [
                              Expanded(
                                child: _InfoBlock(label: 'Tanggal', value: Formatters.dateLong(_data!.tanggal)),
                              ),
                              Expanded(
                                child: _InfoBlock(label: 'Supplier', value: _data!.supplier?.nama ?? '-'),
                              ),
                            ]),
